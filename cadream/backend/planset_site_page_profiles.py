...
def _profile(
    ...
    lock_keywords: list[str] | None = None,
) -> dict[str, Any]:
    return {
        ...
        "lock_keywords": lock_keywords or [],
        "editable_entities": [
            "block_insert",
            "polyline",
            "text",
...
CORE_SITE_PAGE_PROFILES: list[dict[str, Any]] = [
    _profile(
        ...
        ["site", "road", "boundary", "building", "equipment", "cable", "conduit", "transformer", "switchgear", "meter"],
    ),
    _profile(
        2,
        ...
        ["bess", "battery", "container", "pcs", "inverter", "transformer", "equipment"],
    ),
    _profile(
        4,
        ...
        ["cable", "conduit", "trench", "route", "duct", "switchgear", "panel", "meter"],
    ),
    _profile(
        5,
        ...
        ["cable", "conduit", "trench", "route", "duct", "detail"],
    ),
    _profile(
        6,
        ...
        ["poi", "utility", "meter", "grid", "interconnect", "switchgear", "panel", "transformer"],
    ),
    _profile(
        7,
        ...
        ["bess", "battery", "equipment", "road", "access", "path", "aisle"],
    ),
]
...
FOLLOW_ON_SITE_PAGE_PROFILES: list[dict[str, Any]] = [
    _profile(
        ...
        ["site", "road", "boundary", "building", "utility", "note"],
    ),
    _profile(
        13,
        ...
        ["bess", "battery", "equipment", "pcs", "inverter", "transformer", "label"],
    ),
    _profile(
        16,
        "Routing Detail A",
        ...
        ["cable", "conduit", "trench", "route", "bend", "detail"],
    ),
    _profile(
        17,
        "Routing Detail B",
        ...
        ["north_arrow", "segment_lengths", "detail_bubbles"],
        ["cable", "conduit", "trench", "route", "secondary", "detail"],
    ),
    _profile(
        42,
        ...
        ["utility", "road", "corridor", "route", "cable", "interconnect", "grid"],
    ),
    _profile(
        43,
        ...
        ["poi", "interconnect", "meter", "utility", "grid", "switchgear", "tie"],
    ),
]
